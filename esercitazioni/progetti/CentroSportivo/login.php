    ...
    <?php
        ...
        if(!empty($_POST)){
            if($_GET['stato'] == 'signup'){
                ...
                if(!(isset($_POST['name']) && isset($_POST['surname']) && isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm_password']))){
                    ...
                    if(isset($_POST['societa'])){
                        $user->set_societa($_POST['societa']);
                    }
                    $user->user_save($file);
                    $utente_salvato = true;
                }
            ...
            elseif($_GET['stato'] == 'login'){
                ...
                } elseif (!$user->check_login($_POST['username'], $_POST['password'], $file, $file_team)) {
                    $condizioni_valide = false;
        ...
        <?php else: ?>
            <?php if($_GET['stato'] == 'signup') : ?>
                <form action="" method="POST" class='container'>
                    ...
                    <input type="text" name="societa" id="societa" value="<?php echo $_POST['societa'] ??  ''; ?>">
